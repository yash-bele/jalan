  ...
  return (
    <>
      ...
      <main className='absolute w-full h-full flex items-center justify-center bg-slate-700'>
        ...
        <pre className='p-5 pb-7 sm:p-5 bg-slate-900 text-white rounded-md duration-200 shadow-md hover:shadow-lg relative overflow-x-scroll w-11/12 text-sm sm:text-base sm:w-auto sm:overflow-auto scrollbar scrollbar-thin scrollbar-thumb-slate-400 scrollbar-thumb-rounded-md hover:scrollbar-thumb-slate-200'>
          <BsClipboard
            onClick={handleClick}
